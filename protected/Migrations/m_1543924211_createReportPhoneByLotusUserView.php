...
class m_1543924211_createReportPhoneByLotusUserView
    extends Migration
{
        ...
        $sql['create_view.report_phone_by_lotus_user '] = '
            CREATE VIEW '.$targetView.' AS
                WITH
                    ...
                    appliance AS (
                        WITH
                            appliance AS (SELECT __id, __platform_item_id, __location_id FROM equipment.appliances),
                    ...
                    "phoneBook" AS (
                        SELECT
                            (name || \' \' || patronymic || \' \' || surname) AS name,
                            position,
                            division,
                            work_phone,
                            mobile_phone
    ...
    {
        $targetView = 'view.report_phone_by_lotus_user';
        $sql['drop_view.report_phone_by_lotus_user '] = 'DROP VIEW IF EXISTS '.$targetView;
