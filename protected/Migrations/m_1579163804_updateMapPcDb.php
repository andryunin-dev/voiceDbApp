...
class m_1579163804_updateMapPcDb
    extends Migration
{
    ...
    public function up()
    {
        ...
        $sql['drop foreign table'] = 'DROP FOREIGN TABLE IF EXISTS pc.pc_data_view';
        $sql['import foreign schema'] = 'IMPORT FOREIGN SCHEMA "view"
        ...
        $sql['create view mappedPcData'] = 'CREATE VIEW view."mappedPcData" AS
            ...
            LEFT JOIN employee ON pc.pc_ses_login = employee.net_name AND pc.pc_ses_domain = employee.domain
