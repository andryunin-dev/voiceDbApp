...
class m_1530010524_changeDevModule1cView
    extends Migration
{

    public function up()
    {
        $sql['drop_old_view.dev_module1c'] = 'DROP VIEW view.dev_module1c';
        $sql['create_view.dev_module1c'] = '
            CREATE OR REPLACE VIEW view.dev_module1c AS
            SELECT
                module1C."__id"                           AS "module1C_id",
                moduleItem."__id"                         AS "module_id",
            ...
            FROM "storage_1c"."modules1C" AS module1C
            LEFT JOIN equipment."moduleItems" AS moduleItem ON moduleItem.__id = module1C.__voice_module_id
            LEFT JOIN "storage_1c"."inventoryItem1C" AS inventoryItem1C ON inventoryItem1C.__id = module1C.__inventory_item_id
    ...
    {
        $sql['drop_view.dev_module1c'] = 'DROP VIEW view.dev_module1c';
        $sql['create_old_view.dev_module1c'] = '
            CREATE OR REPLACE VIEW view.dev_module1c AS
            SELECT
                module1C."__id"                           AS "module1C_id",
                moduleItem."__id"                         AS "module_id",
