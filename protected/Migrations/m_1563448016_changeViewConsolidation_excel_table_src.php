...
class m_1563448016_changeViewConsolidation_excel_table_src
    extends Migration
{
  ...
  WITH "lotusUsers" AS (
    ...
    SELECT inventory_number inv_number,
           type_of_nomenclature nomenclature_type,
           status,
           comment
  ...
  SELECT dev_id,
         ...
         psw.gw_platform,
         psw."gw_invNumber",
         one_c_info.status status_1c,
         one_c_info.comment comment_1c
  FROM ((((("invItem"
      ...
      LEFT JOIN one_c_info ON (one_c_info.inv_number = ("invItem"."invNumber")::citext AND one_c_info.nomenclature_type = "invItem"."nomenclatureType_1c")
        ';
