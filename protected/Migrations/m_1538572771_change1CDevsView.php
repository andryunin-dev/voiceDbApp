...
class m_1538572771_change1CDevsView
    extends Migration
{
            ...
            inventory_1c AS (
                SELECT
                       ...
                       "inventoryNumber" AS inventory_number,
                        ntype.type AS nomenclature_type
                FROM storage_1c."appliances1C"
                JOIN storage_1c."inventoryItem1C" ON "appliances1C".__inventory_item_id = "inventoryItem1C".__id
                JOIN storage_1c."nomenclature1C" ON "inventoryItem1C".__nomenclature_id = "nomenclature1C".__id
                JOIN storage_1c."nomenclatureTypes" AS ntype ON "nomenclature1C".__type_id = ntype.__id
              ),
            ip_to_dev_info AS (
                SELECT
                       "ipAddress",
