...
/**
 * Class Dev_Appliance1C
 * @package App\ViewModels
 *
 * @property int $appliance1C_id
 * @property int $appliance_id
 * @property string $appliance_serialNumber
...
class Dev_Appliance1C extends Model
{
    protected static $schema = [
        'table' => 'view.dev_appliance1c',
        'columns' => [
            'appliance1C_id' => ['type' => 'int', 'length' => 'big'],
            'appliance_id' => ['type' => 'int', 'length' => 'big'],
            'appliance_serialNumber' => ['type' => 'string'],
