 ...
 *
 * @property int module1C_id
 * @property int module_id
 * @property string module_serialNumber
 ...
 */
class Dev_Module1C extends Model
{
    protected static $schema = [
        'table' => 'view.dev_module1c',
        'columns' => [
            'module1C_id' => ['type' => 'int', 'length' => 'big'],
            'module_id' => ['type' => 'int', 'length' => 'big'],
            'module_serialNumber' => ['type' => 'string'],
